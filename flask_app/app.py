...
model_name = "model_Log_Reg"   # your model folder name inside "models"

def get_latest_model_version(model_name):
    """Get the latest version number (v1, v2, ...) from the local pseudo registry."""
...
model_version = get_latest_model_version(model_name)
model_uri = os.path.join("models", model_name, model_version, "model.pkl")
...
model = pickle.load(open(model_uri, "rb"))
vectorizer = pickle.load(open("models/vectorizer.pkl", "rb"))
