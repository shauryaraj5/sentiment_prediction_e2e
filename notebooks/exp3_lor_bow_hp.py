# Logistic Regression with Bag-of-Words and Hyperparameter Tuning
# This script implements a Logistic Regression model using Bag-of-Words representation and performs hyperparameter tuning
# using GridSearchCV. The results, including hyperparameters and evaluation metrics, are logged to MLflow.
...
def train_and_log_model(X_train, X_test, y_train, y_test, vectorizer):
    ...
    with mlflow.start_run():
        ...
        mlflow.sklearn.save_model(model, "exp_models/exp-3")
